...
class CountryAndRegionData extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $country->addRegion(new Region('British Colombia', 'BC'));
        $country->addRegion(new Region('Manitoba', 'MB'));
        $country->addRegion(new Region('New Brunswick', 'NB'));
        $country->addRegion(new Region('Newfoundland', 'NL'));
        ...
        $country->addRegion(new Region('Baja', 'Cal'));
        $country->addRegion(new Region('Baja', 'Cal'));
        $country->addRegion(new Region('Campeche', 'CAM'));
        $country->addRegion(new Region('Chiapas', 'CHS'));
        $country->addRegion(new Region('Chihuahua', 'CHI'));
        $country->addRegion(new Region('Coahuila', 'COA'));
        $country->addRegion(new Region('Colima', 'COL'));
        $country->addRegion(new Region('Distrito', 'Fed'));
        $country->addRegion(new Region('Durango', 'DGO'));
        $country->addRegion(new Region('Guanajuato', 'GTO'));
        $country->addRegion(new Region('Guerrero', 'GRO'));
        $country->addRegion(new Region('Hidalgo', 'HGO'));
        $country->addRegion(new Region('Jalisco', 'JAL'));
        $country->addRegion(new Region('Mexico', 'MEX'));
        $country->addRegion(new Region('Michoacan', 'de'));
        $country->addRegion(new Region('Morelos', 'MOR'));
        $country->addRegion(new Region('Nayarit', 'NAY'));
        $country->addRegion(new Region('Nuevo', 'Leo'));
        $country->addRegion(new Region('Oaxaca', 'OAX'));
        $country->addRegion(new Region('Puebla', 'PUE'));
        $country->addRegion(new Region('Queretaro', 'de'));
        $country->addRegion(new Region('Quintana', 'Roo'));
        $country->addRegion(new Region('San', 'Lui'));
        ...
        $country->addRegion(new Region('Veracruz-Llave', 'VER'));
        $country->addRegion(new Region('Yucatan', 'YUC'));
        ...
        $country->addRegion(new Region('Marshall islands', 'MH'));
        ...
        $country->addRegion(new Region('Palau', 'PW'));
        ...
        $country = new Country('United States Minor Outlying Islands', 'UM', 'UMI');
        $manager->persist($country);
